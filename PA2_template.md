...
There are 985 event types which will be investigated to determine data quality and cleaning procedures.  
...
The chart also shows that the biggest contributor to crop loss in economic terms is hail which is responsible for about two million dollars in damages.
